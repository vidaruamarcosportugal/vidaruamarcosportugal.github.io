...
- [ ] Convert it to flashcard to review it more often
...
- s'essayer (à [qch]) v pron
- tâter (de [qch]) (figuré)
- [faire [qch]] en dilettante <br>
`"Are you a painter?" "I've been known to dabble."` <br>
...
grin⇒ vi
(smile) (en montrant les dents)
faire un large sourire, arborer un large sourire, sourire de toutes ses dents loc v
 
...
(smile broadly at)
faire un grand/large sourire à loc v + prép
 
...
unabashed adj
(person: not ashamed)
nullement déconcerté, nullement décontenancé, nullement intimidé (par [qch]) loc adj
 
 
sans complexe, sans honte loc adj
 
Rita was unabashed in her criticism of her brother.
 
Rita critiquait son frère sans complexe (or: sans honte).
unabashed adj
(emotion: not concealed)
non dissimulé loc adj
 
 
évident adj
 
...
harrumph⇒ vi
(express indignation) 
s'offusquer⇒ v pron<br>

---

hazy adj
(atmosphere)
brumeux, brumeuse adj
 
 
it is hazy : il y a de la brume adj
 
 (littéraire : lumière)
vaporeux, vaporeuse adj
 
...
 
Il y avait de la brume ; Jim n'arrivait même pas à voir les maisons au bout de la rue.

---

bummer n
slang, US (sthg disappointing)
déception nf
 
 
...
idiosyncrasy n
(quirk)
particularité, idiosyncrasie nf
 
 
manie nf
 
The software has some idiosyncrasies, but it works.
 
...
relire⇒, revoir⇒, corriger⇒vtr
 
 
(
édition, imprimerie
)
corriger (les épreuves de)vtr
...
dazzling adj
(that blinds)
aveuglant, éblouissant adj


dazzling adj
figurative (impressive)
éblouissant, éclatant, impressionnant adj

---

bereavement n
(loss of [sb] loved)
perte (d'un être cher) nf
 
The shop will be closed all week due to a bereavement in the family.
bereavement n
(grief, mourning)
deuil nm
bereavement n as adj
...
 
Michel-Ange aimait sculpter de gigantesques nus dans le marbre.
carve [sth] out of[sth] vtr
(shape: sculpt)
sculpter qch en qch, sculpter qch à partir de qch vtr
carve [sth] vtr
(meat: cut, slice) 
(
de la viande
...
découper⇒ vtr
 
Qui est volontaire pour découper le poulet ?
...
swamp [sb]with [sth],
swamp [sth],
swamp [sth]with [sth] vtr
figurative (overload: with work, etc.) 
(
figuré : une personne
)
submerger qqn (de qch), surcharger qqn (de qch) vtr
 
 
(
figuré : un marché
)
inonder qch (de qch) vtr
...
bourbeux, détrempé adj
 
The pasta was overcooked and mushy.
 
Les pâtes étaient trop cuites et toutes molles (or: ramollies).
mushyadj
figurative (excessively sentimental)
très fleur bleue, à l'eau de rose, à la guimauveloc adj
 
...
grotte, caverne nf
pothole n
(dip in surface of road or path)
nid-de-poule nm
...
rattlevi
(make rattling noise)
faire un bruit de ferraille, cliqueter⇒ vi
 
The box rattled when Tina shook it.
rattle[sth]vtr
(shake and make noise)
faire s'entrechoquer⇒ vtr
 
...
hochet nm
 
Le bébé jouait avec son hochet.
rattle n
(rattling noise)
bruit de ferraille nm
 
...
 
ⓘ La travée était revêtue d'asphalte.
span n
(width between wing tips) 
(
d'un oiseau
)
envergure nf
...
écartement nm
 
Your hand span is the measurement from your thumb to your little finger.
 
L'écartement de la main se mesure du pouce au petit doigt.
span [sth] vtr
(bridge, go across)
enjamber⇒ vtr
 
...
capacité de concentration nf
 
Most adults have an attention span of about 20 minutes.
eye span n
(words taken in at one glance)
portée du regard nf
life span n
(period of existence)
durée de vie nf
...
 
 
capacité mémorielle nf
 
Il a la mémoire d'un poisson rouge.
mid-span
...
Traductions supplémentaires
tie n
(string, etc., for attaching things) 
(
nœud
)
lien nm
...
égaliser⇒ vi
 
The two teams were tied in skill. The Canadian team tied the French.
 
ⓘ L'équipe canadienne a égalisé dans les dernières minutes du match.
tie [sb] to [sth/sb]vtr
figurative, often passive (restrict) 
(
figuré
)
lier⇒ vtr
...
tie [sth] vtr
often passive (connect: musical notes) 
(
Musique : des notes
)
lier⇒ vtr
...
mingle vi
(with people)
se mélanger⇒, se mêler⇒ v pron
 
Paul liked to mingle with people.
 
Traductions supplémentaires
mingle [sth] with[sth] vtr
(combine, mix)
mélanger qch à qch vtr + prép
 
The cook mingled sugar in with the other ingredients in a bowl before pouring it all into a dish.
...
stint n
(session of work, duty)
période (de travail) nf
 
...
pourchasser⇒, poursuivre⇒, prendre en chassevtr
 
 
...
 
Les chiens ont couru après lapin.
 
Les chiens ont coursé lapin.
...
délit mineur nm
misdemeanor n
(act of bad behaviour)
écart de conduite nm
...
 
forcer qnn vtr
coerce [sb] into [sth] vtr
(force, compel)
contraindre qqn à qch vtr
 
 
forcer qqn à qch vtr
 
ⓘ Ils furent tous contraints au silence.
coerce [sb] into doing[sth] vtr
(force, compel)
contraindre qqn à faire qch vtr
 
 
forcer qqn à faire qch vtr
 
...
coerce [sth] from [sb] vtr
(bring about by force)
obtenir qch de qqn par la force vtr
 
...
plaster [sth] vtr
(walls: coat with plaster)
plâtrer⇒ vtr
 
 
enduire de plâtre⇒ vtr
...
 
Le chien a essayé de casser l'os pour atteindre la moelle à l'intérieur.
marrow n
UK (vegetable: large squash)
courge nf
 
Neville won a prize for growing the largest marrow.
 
Neville a remporté le prix de la plus grosse courge.
...
mercilessadj
(person: without pity)
impitoyable, sans pitié, implacable adj
 
...
impitoyable, sans pitié adj

---
skipping a beat = sans hésitation / dans la foulée
---
...
---
keep it under wraps = tenez le secret
http://www.linguee.fr/francais-anglais/search?source=auto&query=keep+it+under+wraps
---
...
 
La moyenne de la durée de vie humaine augmente dans la plupart des pays.
lifespan n
(goods: duration)
durée de vie nf
 
...
 
Ces aliments n'ont qu'une durée de vie de quelques semaines.
...
être en phase avec qch loc v
(être en accord avec qch)
be in tune with [sth] v expr
 
Chaque employé doit être en phase avec la politique de l'entreprise.
être en phase avec qqn loc v
(être en harmonie avec qqn)
be in tune with [sb] v expr
 
Pour gagner un double, il faut être en phase avec son partenaire.

---

spanking adv
informal (strikingly)
spanking new : flambant neuf loc adj
 
 
spanking white : d'un blanc éclatant loc adj
 
 
spanking clean : d'une propreté éclatante loc adj
 
...
stagger[sth] vtr
(spread over time)
étaler⇒, échelonner⇒ vtr

---

whinge,
Aus: winge vi
UK, Aus, informal (complain, whine) 
(
familier
)
râler⇒ vi
...
 
gré nm
Note: of my own volition : de mon propre gré
 
...
peu sérieux, peu sérieuse loc adj
 
...
 
Le travail de Daphne n'est pas vraiment bon ; je crois qu'elle est peu sérieuse.
slack n
(rope: looseness)
mou (d'une corde) nm
 
...
haphazardadj
(random)
incohérent, incertain, désordonné, désorganisé adj
...
the bulk of[sth] n
(most, greater part)
l'essentiel de qch nm
 
 
le plus gros de qch nm
 
 
la majeure partie de qchnf
 
...
 
Vu qu'il était fauché, Sam a essayé de faire du troc pour pouvoir manger.
 
ⓘ J'ai troqué mes vieilles baskets contre une chemise neuve.
barter for [sth] vi + prep
(haggle)
troquer⇒ vtr
 
...
 
À une époque, les biens et services s'obtenaient grâce au troc.
...
scroogen
figurative, informal (miserly person) 
(
familier
)
grippe-sou, rapiat, pingre, harpagonnm
...
souple, serviable, maniable adj
 
 
(
personne
)
disposé à faire qch, prêt à faire qchadj
 
 
(
à un traitement
)
réactif à qch, réactive à qch adj + prép
 
...
(willing)
disposé à, prêt à ajd + prép
amenable to doing[sth] adj
(willing to do)
disposé à faire qch, prêt à faire qchadj + prép
 
...
cas particulier, cas unique nm
outlier n
(differing person or thing)
cas particulier, cas unique nm
 
 
personne/chose qui fait figure d'exc
...
graine nf
 
The thresher separates the kernels from their husks.
 
...
noyau nm
 
The kernel manages input/output requests from applications on your computer.
 
Le noyau gère les requêtes d'entrées et de sorties de l'application dans votre ordinateur.
...
 
(
pièce de maison bourgeoise
)
office nm
 
 
(
pièce dans maison plus modeste
)
cellier nm
 
...
sprain[sth] vtr
(injure a joint)
se fouler qch v pron
 
 
se faire une entorse à v pron + prép
 
...
---
evolution (monkey) => change over time
---
...
scatter [sth] across[sth] vtr + prep
(sprinkle, strew [sth])
éparpiller qch sur qch, éparpiller qch à travers qch vtr + prép
 
I scattered a few rose petals over her pillow while she was in the bathroom.
 
J'ai éparpillé quelques pétales de rose sur son 
...
automation n
 
L'automatisation de la construction a limité le travail à la chaîne.
...
porter [qqn] sur son dos vtr
 
 
porter [qqn] à califourchon vtr
 
...
se servir de, tirer parti de v pron
 
If I can piggyback on your idea, I'd like to add something.
piggyback vi
US, informal, figurative (be carried, attached to [sth] else)
s'annexer à, s'attacher à v pron
...
tidbit (US),
titbit (UK) n
figurative (piece of information)
information nf
 
 
(
...
 grind the coffee to a coarse and even ground
---
...
fickleadj
(person)
volage, changeant, inconstant adj
 
 
capricieux, capricieuse adj
 
...
 
ⓘ Kevin a offert à sa grand-mère une reproduction de Mona Lisa en puzzle pour Noël.
...
 
La reine a envoyé un héraut pour délivrer son message.
herald n
figurative (sign of [sth])
signe avant-coureur, signe annonciateur nm
 
Robins are a dependable herald of spring.
 
Les hirondelles sont un signe avant-coureur fiable du printemps.
...
Français
brittle adj
figurative (voice: sharp, nervous) 
(
figuré : voix
)
craquelant adj
...
 
The teacher's voice was brittle with irritation.
 
...
flexion, adjonction de désinence, déclinaison nf
...
lackluster,
UK: lacklustre adj
US, figurative (dull, lacking liveliness) 
(
figuré
)
terne adj
...
 
 
faire paraître petit vtr
 
 
être gigantesque par rapport à vi + adj + prép
...
vent vi
(release anger, frustration) (figuré, familier)
vider son sac loc v
 
 
se défouler⇒ v pron
...
corde d'assurance, corde de sécurité, corde de sauvegarde nf
 
 
cordage, filin nm
 
...
lifelinen
figurative (means or source of support)
vivres nmpl
 
 
lien vital nm
...
booze vi
informal (drink, get drunk) (familier)
picoler⇒ vi
...
booze it up v expr
(drink a lot of alcohol) (familier)
picoler⇒ vi
booze-up n
informal, UK (alcoholic drinking session) (familier)
beuverie, cuite nf
 
Fancy a booze-up with the lads tonight?
go out on the booze,
go on the booze v expr
informal (visit pubs, bars to drink alcohol)
faire la tournée 

---

reproductibleadj
(qui peut être reproduit) (results, etc.)
reproducible adj
 
 
replicable adj
 
 
that can be reproduced expr
 
 
that can be replicated expr

---

quibble n
(petty remark or objection)
(petite) critique nf
...
loophole n
figurative (law, rules: technicality) (figuré)
faille nf
...
 
Cela ne nous laisse qu'une marge de sécurité de cinq minutes pour atteindre l'aéroport.
leeway n
(freedom, flexibility)
marge de manœuvre nf
...
untethered adj
(not tied with a rope or chain)
détaché adj
 
 
plus attaché loc adj
untethered adj
figurative (action, thought: unrestricted) (figuré)
libre adj
untethered adj
figurative (digital devices: not linked) (objet électronique)
non lié loc adj
...
 
Toutes les tentatives pour l'hypnotiser ont échoué.
...
 
 
avoir une sainte horreur de [qch] loc v
 
 (fautes d'orthographe,...)
rien n'exaspère autant [qqn]que [qch] expr
...
vagaries n
usu. Pl (whim, unpredictable change)
caprice nm

Les caprices des éléments risquent de retarder le tournoi.

spe•lunk (spi lungk′), v.i.
1. to explore caves, esp. as a hobby.
