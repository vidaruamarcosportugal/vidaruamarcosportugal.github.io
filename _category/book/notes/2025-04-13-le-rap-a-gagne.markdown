...
layout: default
tag: book
permalink: "/category/book/notes/Le-rap-a-gagne"
date: 2025-04-13
book_title: 'Le rap a gagné'
---
...
Depuis le début de l'année j'avais envi de comprendre ce qui s'était passé ces 20 dernières années dans le rap et en ce sens c'était l'ouvrage parfait.<br>
Mon dernier crush remontait à la découverte de Népal en 2022 _(merci Boubou)_, et plus récemment Limsa d'Aulnay et l'excellent 'Bitume Caviar'.<br><br>

Beaucoup de références, des playlists pour chaque période et des analyses / points de vue intéressants sur l'évolution du rap, de l'industrie musicale, du rapport à la politique et à la pop mondiale.<br><br>

A garder en livre de chevet !
