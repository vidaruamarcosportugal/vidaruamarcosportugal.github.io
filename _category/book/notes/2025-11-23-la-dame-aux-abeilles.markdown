...
layout: default
tag: book
permalink: "/category/book/notes/La-dame-aux-abeilles"
date: 2025-11-23
book_title: "La dame aux abeilles"
---
...
{% for book in site.data.books %}
    ...
    {%- if status == 'read' -%}
        {%- if title == 'La dame aux abeilless' -%}
...
C'est doux, très instructif, avec un ton qu'on reconnait bien après 'Une année à la campagne' et plus subversif qu'il n'y parait.<br>
J'envie sa connaissance des plantes, des abeilles... et globalement sa capacité à s'émerveiller face au monde et à la vie.<br>
J'ai l'impression d'avoir été bouquiner au coin du feu dans un chalet reculé, comme pour 'Une année à la campagne' et ça c'est génial.<br>
Dommage qu'elle ne soit plus de ce monde, on a envi d'échanger avec elle et d'apprendre à ses côtés.
